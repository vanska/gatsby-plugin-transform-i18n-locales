exports.onCreateNode = async ({
  ...
  if (node.sourceInstanceName == "i18n-locales" && node.internal.mediaType == "application/json") {
    ...
    Object.keys(parsedTranslationContent).forEach((key, i) => {
      ...
      let slug = parsedTranslationContent[key].slug !== "undefined" && parsedTranslationContent[key].slug
      ...
      let filteredObj = Object.entries(namespaceObject)
        .reduce((a,[k,v]) => (
          v 
            ? {...a, [k]:v} 
            : a)
